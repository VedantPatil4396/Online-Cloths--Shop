...
public class CustomerLoginController {
	...
	public Optional<CustomerLogin> getCustomerLogin(@PathVariable String email, @PathVariable String pass) {
		
		System.out.println(email);
		System.out.println(pass);
		System.out.println(custlogin.findByCustEmailAndCustPassword(email, pass));
